...
export declare const HandleOnSave: (values: any, collection: string, editingId: number | undefined, content: (IRecordLayout | IField)[], customSaveParser?: ICustomSaveParser) => any;
